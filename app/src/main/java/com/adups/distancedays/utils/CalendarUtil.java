...
public class CalendarUtil {
     ...
     * @author liu 2015-1-5
     */
    public static int[] lunarToSolar(int year, int month, int monthDay, boolean leapMonthFlag) throws Exception {
        int lunarYear = year;
        int lunarMonth = month;
        int lunarDay = monthDay;
        ...
        solarInfo[0] = c.get(Calendar.YEAR);
        solarInfo[1] = c.get(Calendar.MONTH);
        solarInfo[2] = c.get(Calendar.DAY_OF_MONTH);
